...
class BasicEdgeClassificationChallenge(MicroChallenge):
    def __init__(self, hparams):
        ...
        self.dataset_class = BasicEdgeClassificationDataset
...
class BasicEdgeClassificationDataset(Dataset):
    ...
    def __init__(self, num_events=None, hparams=None, input_dir=None, data_name=None, transform=None, pre_transform=None, pre_filter=None):
        ...
        self.event_generator = EventGenerator(self.particle_gun, self.detector, num_particles=self.hparams.get("num_particles", 10))
